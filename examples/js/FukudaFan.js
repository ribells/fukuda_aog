...
// Overlaying the Fukuda image over another base image is enabled by setting "masked".
//
...
let    masked      = false;     // use Fukuda image as a mask over another image, see Figure 5b
...
let    mimage      = "https://4.bp.blogspot.com/-qkjD7dZFpmE/UWOB-t5cbDI/AAAAAAAAMeo/TI50nDL9TtI/s1600/We-Can-Do-It-Rosie-the-Riveter-Poster-Vintage-Poster.jpg";
...
function FukudaFan() {
	...
	if (masked)
        stroke(20,   0,   0, 255);    // draw black strips when masking
	else
